...
-- Represents a thread between two users (usually about a specific listing)
CREATE TABLE IF NOT EXISTS public.conversations (
    ...
    -- Constraints
    CONSTRAINT unique_conversation UNIQUE (listing_id, landlord_id, tenant_id)
);
...
-- 7. Helper Indexes
CREATE INDEX IF NOT EXISTS idx_conversations_participants ON public.conversations(landlord_id, tenant_id);
